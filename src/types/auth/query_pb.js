...
proto.cosmos.auth.v1beta1.QueryAccountsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    auth_auth_pb.BaseAccount.toObject, includeInstance),
 ...
 * @return {!Array<!proto.cosmos.auth.v1beta1.BaseAccount>}
 */
proto.cosmos.auth.v1beta1.QueryAccountsResponse.prototype.getAccountsList = function() {
  return /** @type{!Array<!proto.cosmos.auth.v1beta1.BaseAccount>} */ (
    jspb.Message.getRepeatedWrapperField(this, auth_auth_pb.BaseAccount, 1));
};


/**
 * @param {!Array<!proto.cosmos.auth.v1beta1.BaseAccount>} value
...
/**
 * @param {!proto.cosmos.auth.v1beta1.BaseAccount=} opt_value
...
proto.cosmos.auth.v1beta1.QueryAccountsResponse.prototype.addAccounts = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.cosmos.auth.v1beta1.BaseAccount, opt_index);
};
...
proto.cosmos.auth.v1beta1.QueryParamsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    params: (f = msg.getParams()) && auth_auth_pb.Params.toObject(includeInstance, f)
  };
...
proto.cosmos.auth.v1beta1.QueryParamsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new auth_auth_pb.Params;
      reader.readMessage(value,auth_auth_pb.Params.deserializeBinaryFromReader);
      msg.setParams(value);
      break;
    default:
      reader.skipField();
...
proto.cosmos.auth.v1beta1.QueryParamsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      auth_auth_pb.Params.serializeBinaryToWriter
    );
  }
};
...
proto.cosmos.auth.v1beta1.QueryParamsResponse.prototype.getParams = function() {
  return /** @type{?proto.cosmos.auth.v1beta1.Params} */ (
    jspb.Message.getWrapperField(this, auth_auth_pb.Params, 1));
};
