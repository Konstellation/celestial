...
interface IQueryService_IAccounts
    extends grpc.MethodDefinition<auth_query_pb.QueryAccountsRequest, auth_query_pb.QueryAccountsResponse> {
...
interface IQueryService_IAccount
    extends grpc.MethodDefinition<auth_query_pb.QueryAccountRequest, auth_query_pb.QueryAccountResponse> {
...
interface IQueryService_IParams
    extends grpc.MethodDefinition<auth_query_pb.QueryParamsRequest, auth_query_pb.QueryParamsResponse> {
...
export interface IQueryClient {
    accounts(
        request: auth_query_pb.QueryAccountsRequest,
        callback: (error: grpc.ServiceError | null, response: auth_query_pb.QueryAccountsResponse) => void,
    ...
    account(
        request: auth_query_pb.QueryAccountRequest,
        callback: (error: grpc.ServiceError | null, response: auth_query_pb.QueryAccountResponse) => void,
    ): grpc.ClientUnaryCall;
    account(
        request: auth_query_pb.QueryAccountRequest,
        metadata: grpc.Metadata,
    ...
    params(
        ...
        callback: (error: grpc.ServiceError | null, response: auth_query_pb.QueryParamsResponse) => void,
    ): grpc.ClientUnaryCall;
    params(
        request: auth_query_pb.QueryParamsRequest,
        metadata: grpc.Metadata,
