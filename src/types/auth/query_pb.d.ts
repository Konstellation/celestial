...
export class QueryAccountsRequest extends jspb.Message { 
    ...
    setPagination(value?: pagination_pb.PageRequest): QueryAccountsRequest;
...
export class QueryAccountsResponse extends jspb.Message { 
    ...
    setAccountsList(value: Array<auth_auth_pb.BaseAccount>): QueryAccountsResponse;
    ...
    setPagination(value?: pagination_pb.PageResponse): QueryAccountsResponse;
...
export class QueryAccountResponse extends jspb.Message { 
    ...
    hasAccount(): boolean;
    clearAccount(): void;
    getAccount(): auth_auth_pb.BaseAccount | undefined;
    setAccount(value?: auth_auth_pb.BaseAccount): QueryAccountResponse;
...
export namespace QueryAccountResponse {
    export type AsObject = {
        account?: auth_auth_pb.BaseAccount.AsObject,
    }
}
...
export class QueryParamsResponse extends jspb.Message { 
    ...
    setParams(value?: auth_auth_pb.Params): QueryParamsResponse;
