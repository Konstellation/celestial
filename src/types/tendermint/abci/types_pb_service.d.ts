...
export class ABCIApplicationClient {
    ...
    setOption(
        ...
        callback: (
            ...
            responseMessage: tendermint_abci_types_pb.ResponseSetOption | null,
        ) => void,
    ): UnaryResponse;
    setOption(
        requestMessage: tendermint_abci_types_pb.RequestSetOption,
    ...
    deliverTx(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: tendermint_abci_types_pb.ResponseDeliverTx | null,
        ) => void,
    ): UnaryResponse;
    deliverTx(
        requestMessage: tendermint_abci_types_pb.RequestDeliverTx,
    ...
    checkTx(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: tendermint_abci_types_pb.ResponseCheckTx | null,
        ) => void,
    ): UnaryResponse;
    checkTx(
        requestMessage: tendermint_abci_types_pb.RequestCheckTx,
    ...
    initChain(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: tendermint_abci_types_pb.ResponseInitChain | null,
        ) => void,
    ): UnaryResponse;
    initChain(
        requestMessage: tendermint_abci_types_pb.RequestInitChain,
    ...
    beginBlock(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: tendermint_abci_types_pb.ResponseBeginBlock | null,
        ) => void,
    ): UnaryResponse;
    beginBlock(
        requestMessage: tendermint_abci_types_pb.RequestBeginBlock,
    ...
    endBlock(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: tendermint_abci_types_pb.ResponseEndBlock | null,
        ) => void,
    ): UnaryResponse;
    endBlock(
        requestMessage: tendermint_abci_types_pb.RequestEndBlock,
    ...
    listSnapshots(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: tendermint_abci_types_pb.ResponseListSnapshots | null,
        ) => void,
    ): UnaryResponse;
    listSnapshots(
        requestMessage: tendermint_abci_types_pb.RequestListSnapshots,
    ...
    offerSnapshot(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: tendermint_abci_types_pb.ResponseOfferSnapshot | null,
        ) => void,
    ): UnaryResponse;
    offerSnapshot(
        requestMessage: tendermint_abci_types_pb.RequestOfferSnapshot,
    ...
    loadSnapshotChunk(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: tendermint_abci_types_pb.ResponseLoadSnapshotChunk | null,
        ) => void,
    ): UnaryResponse;
    loadSnapshotChunk(
        requestMessage: tendermint_abci_types_pb.RequestLoadSnapshotChunk,
    ...
    applySnapshotChunk(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: tendermint_abci_types_pb.ResponseApplySnapshotChunk | null,
        ) => void,
    ): UnaryResponse;
    applySnapshotChunk(
        requestMessage: tendermint_abci_types_pb.RequestApplySnapshotChunk,
