...
goog.object.extend(proto, abci_pb);
var tx_tx_pb = require('../tx/tx_pb.js');
goog.object.extend(proto, tx_tx_pb);
...
proto.cosmos.tx.v1beta1.GetTxsEventResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tx_tx_pb.Tx.toObject, includeInstance),
    txResponsesList: jspb.Message.toObjectList(msg.getTxResponsesList(),
    abci_pb.TxResponse.toObject, includeInstance),
...
proto.cosmos.tx.v1beta1.GetTxsEventResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new tx_tx_pb.Tx;
      reader.readMessage(value,tx_tx_pb.Tx.deserializeBinaryFromReader);
      msg.addTxs(value);
      break;
    case 2:
      var value = new abci_pb.TxResponse;
      reader.readMessage(value,abci_pb.TxResponse.deserializeBinaryFromReader);
...
proto.cosmos.tx.v1beta1.GetTxsEventResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      tx_tx_pb.Tx.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      abci_pb.TxResponse.serializeBinaryToWriter
    );
  }
  f = message.getPagination();
  if (f != null) {
...
proto.cosmos.tx.v1beta1.GetTxsEventResponse.prototype.getTxsList = function() {
  return /** @type{!Array<!proto.cosmos.tx.v1beta1.Tx>} */ (
    jspb.Message.getRepeatedWrapperField(this, tx_tx_pb.Tx, 1));
};
...
proto.cosmos.tx.v1beta1.GetTxsEventResponse.prototype.getTxResponsesList = function() {
  return /** @type{!Array<!proto.cosmos.base.abci.v1beta1.TxResponse>} */ (
    jspb.Message.getRepeatedWrapperField(this, abci_pb.TxResponse, 2));
};
...
/**
 * optional cosmos.base.v1beta1.PageResponse pagination = 3;
...
proto.cosmos.tx.v1beta1.GetTxsEventResponse.prototype.getPagination = function() {
  return /** @type{?proto.cosmos.base.v1beta1.PageResponse} */ (
    jspb.Message.getWrapperField(this, pagination_pb.PageResponse, 3));
};
...
proto.cosmos.tx.v1beta1.BroadcastTxResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    txResponse: (f = msg.getTxResponse()) && abci_pb.TxResponse.toObject(includeInstance, f)
  };
...
proto.cosmos.tx.v1beta1.BroadcastTxResponse.prototype.getTxResponse = function() {
  return /** @type{?proto.cosmos.base.abci.v1beta1.TxResponse} */ (
    jspb.Message.getWrapperField(this, abci_pb.TxResponse, 1));
};
...
proto.cosmos.tx.v1beta1.SimulateRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    tx: (f = msg.getTx()) && tx_tx_pb.Tx.toObject(includeInstance, f),
    txBytes: msg.getTxBytes_asB64()
  };
...
proto.cosmos.tx.v1beta1.SimulateRequest.prototype.getTx = function() {
  return /** @type{?proto.cosmos.tx.v1beta1.Tx} */ (
    jspb.Message.getWrapperField(this, tx_tx_pb.Tx, 1));
};
...
proto.cosmos.tx.v1beta1.SimulateResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    gasInfo: (f = msg.getGasInfo()) && abci_pb.GasInfo.toObject(includeInstance, f),
    result: (f = msg.getResult()) && abci_pb.Result.toObject(includeInstance, f)
  };
...
proto.cosmos.tx.v1beta1.SimulateResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new abci_pb.GasInfo;
      reader.readMessage(value,abci_pb.GasInfo.deserializeBinaryFromReader);
      msg.setGasInfo(value);
      break;
    case 2:
      var value = new abci_pb.Result;
      reader.readMessage(value,abci_pb.Result.deserializeBinaryFromReader);
      msg.setResult(value);
      break;
    default:
      reader.skipField();
...
proto.cosmos.tx.v1beta1.SimulateResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      abci_pb.GasInfo.serializeBinaryToWriter
    );
  }
  f = message.getResult();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      abci_pb.Result.serializeBinaryToWriter
    );
  }
};
...
proto.cosmos.tx.v1beta1.SimulateResponse.prototype.getGasInfo = function() {
  return /** @type{?proto.cosmos.base.abci.v1beta1.GasInfo} */ (
    jspb.Message.getWrapperField(this, abci_pb.GasInfo, 1));
};
...
proto.cosmos.tx.v1beta1.SimulateResponse.prototype.getResult = function() {
  return /** @type{?proto.cosmos.base.abci.v1beta1.Result} */ (
    jspb.Message.getWrapperField(this, abci_pb.Result, 2));
};
...
proto.cosmos.tx.v1beta1.GetTxResponse.prototype.getTxResponse = function() {
  return /** @type{?proto.cosmos.base.abci.v1beta1.TxResponse} */ (
    jspb.Message.getWrapperField(this, abci_pb.TxResponse, 2));
};
