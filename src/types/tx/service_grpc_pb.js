...
var tx_service_pb = require('../tx/service_pb.js');
var google_api_annotations_pb = require('../google/api/annotations_pb.js');
var abci_pb = require('../abci_pb.js');
var tx_tx_pb = require('../tx/tx_pb.js');
var pagination_pb = require('../pagination_pb.js');

function serialize_cosmos_tx_v1beta1_BroadcastTxRequest(arg) {
  if (!(arg instanceof tx_service_pb.BroadcastTxRequest)) {
...
function deserialize_cosmos_tx_v1beta1_BroadcastTxRequest(buffer_arg) {
  return tx_service_pb.BroadcastTxRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_tx_v1beta1_BroadcastTxResponse(arg) {
  if (!(arg instanceof tx_service_pb.BroadcastTxResponse)) {
...
function deserialize_cosmos_tx_v1beta1_BroadcastTxResponse(buffer_arg) {
  return tx_service_pb.BroadcastTxResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_tx_v1beta1_GetTxRequest(arg) {
  if (!(arg instanceof tx_service_pb.GetTxRequest)) {
...
function deserialize_cosmos_tx_v1beta1_GetTxRequest(buffer_arg) {
  return tx_service_pb.GetTxRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_tx_v1beta1_GetTxResponse(arg) {
  if (!(arg instanceof tx_service_pb.GetTxResponse)) {
...
function deserialize_cosmos_tx_v1beta1_GetTxResponse(buffer_arg) {
  return tx_service_pb.GetTxResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_tx_v1beta1_GetTxsEventRequest(arg) {
  if (!(arg instanceof tx_service_pb.GetTxsEventRequest)) {
...
function deserialize_cosmos_tx_v1beta1_GetTxsEventRequest(buffer_arg) {
  return tx_service_pb.GetTxsEventRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_tx_v1beta1_GetTxsEventResponse(arg) {
  if (!(arg instanceof tx_service_pb.GetTxsEventResponse)) {
...
function deserialize_cosmos_tx_v1beta1_GetTxsEventResponse(buffer_arg) {
  return tx_service_pb.GetTxsEventResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_tx_v1beta1_SimulateRequest(arg) {
  if (!(arg instanceof tx_service_pb.SimulateRequest)) {
...
function deserialize_cosmos_tx_v1beta1_SimulateRequest(buffer_arg) {
  return tx_service_pb.SimulateRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_tx_v1beta1_SimulateResponse(arg) {
  if (!(arg instanceof tx_service_pb.SimulateResponse)) {
...
function deserialize_cosmos_tx_v1beta1_SimulateResponse(buffer_arg) {
  return tx_service_pb.SimulateResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
