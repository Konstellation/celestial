...
interface IServiceService_ISimulate
    extends grpc.MethodDefinition<tx_service_pb.SimulateRequest, tx_service_pb.SimulateResponse> {
...
interface IServiceService_IGetTx
    extends grpc.MethodDefinition<tx_service_pb.GetTxRequest, tx_service_pb.GetTxResponse> {
...
interface IServiceService_IBroadcastTx
    extends grpc.MethodDefinition<tx_service_pb.BroadcastTxRequest, tx_service_pb.BroadcastTxResponse> {
...
interface IServiceService_IGetTxsEvent
    extends grpc.MethodDefinition<tx_service_pb.GetTxsEventRequest, tx_service_pb.GetTxsEventResponse> {
...
export interface IServiceClient {
    simulate(
        request: tx_service_pb.SimulateRequest,
        callback: (error: grpc.ServiceError | null, response: tx_service_pb.SimulateResponse) => void,
    ...
    getTx(
        request: tx_service_pb.GetTxRequest,
        callback: (error: grpc.ServiceError | null, response: tx_service_pb.GetTxResponse) => void,
    ): grpc.ClientUnaryCall;
    getTx(
        request: tx_service_pb.GetTxRequest,
        metadata: grpc.Metadata,
    ...
    broadcastTx(
        request: tx_service_pb.BroadcastTxRequest,
        callback: (error: grpc.ServiceError | null, response: tx_service_pb.BroadcastTxResponse) => void,
    ): grpc.ClientUnaryCall;
    broadcastTx(
        request: tx_service_pb.BroadcastTxRequest,
        metadata: grpc.Metadata,
    ...
    getTxsEvent(
        request: tx_service_pb.GetTxsEventRequest,
        callback: (error: grpc.ServiceError | null, response: tx_service_pb.GetTxsEventResponse) => void,
    ): grpc.ClientUnaryCall;
    getTxsEvent(
        request: tx_service_pb.GetTxsEventRequest,
        metadata: grpc.Metadata,
