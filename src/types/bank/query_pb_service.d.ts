...
export class QueryClient {
  ...
  denomMetadata(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: bank_query_pb.QueryDenomMetadataResponse|null) => void
  ): UnaryResponse;
  denomMetadata(
    requestMessage: bank_query_pb.QueryDenomMetadataRequest,
    callback: (error: ServiceError|null, responseMessage: bank_query_pb.QueryDenomMetadataResponse|null) => void
  ...
  denomsMetadata(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: bank_query_pb.QueryDenomsMetadataResponse|null) => void
  ): UnaryResponse;
  denomsMetadata(
    requestMessage: bank_query_pb.QueryDenomsMetadataRequest,
    callback: (error: ServiceError|null, responseMessage: bank_query_pb.QueryDenomsMetadataResponse|null) => void
