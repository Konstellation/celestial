...
interface IQueryService_IBalance
    extends grpc.MethodDefinition<bank_query_pb.QueryBalanceRequest, bank_query_pb.QueryBalanceResponse> {
...
interface IQueryService_IAllBalances
    extends grpc.MethodDefinition<bank_query_pb.QueryAllBalancesRequest, bank_query_pb.QueryAllBalancesResponse> {
...
interface IQueryService_ITotalSupply
    extends grpc.MethodDefinition<bank_query_pb.QueryTotalSupplyRequest, bank_query_pb.QueryTotalSupplyResponse> {
...
interface IQueryService_ISupplyOf
    extends grpc.MethodDefinition<bank_query_pb.QuerySupplyOfRequest, bank_query_pb.QuerySupplyOfResponse> {
...
interface IQueryService_IParams
    extends grpc.MethodDefinition<bank_query_pb.QueryParamsRequest, bank_query_pb.QueryParamsResponse> {
...
interface IQueryService_IDenomMetadata
    extends grpc.MethodDefinition<bank_query_pb.QueryDenomMetadataRequest, bank_query_pb.QueryDenomMetadataResponse> {
...
interface IQueryService_IDenomsMetadata
    extends grpc.MethodDefinition<bank_query_pb.QueryDenomsMetadataRequest, bank_query_pb.QueryDenomsMetadataResponse> {
...
export interface IQueryServer {
    ...
    denomMetadata: grpc.handleUnaryCall<
        bank_query_pb.QueryDenomMetadataRequest,
        bank_query_pb.QueryDenomMetadataResponse
    >;
    denomsMetadata: grpc.handleUnaryCall<
        bank_query_pb.QueryDenomsMetadataRequest,
...
export interface IQueryClient {
    balance(
        request: bank_query_pb.QueryBalanceRequest,
        callback: (error: grpc.ServiceError | null, response: bank_query_pb.QueryBalanceResponse) => void,
    ...
    allBalances(
        request: bank_query_pb.QueryAllBalancesRequest,
        callback: (error: grpc.ServiceError | null, response: bank_query_pb.QueryAllBalancesResponse) => void,
    ): grpc.ClientUnaryCall;
    allBalances(
        request: bank_query_pb.QueryAllBalancesRequest,
        metadata: grpc.Metadata,
    ...
    totalSupply(
        ...
        callback: (error: grpc.ServiceError | null, response: bank_query_pb.QueryTotalSupplyResponse) => void,
    ): grpc.ClientUnaryCall;
    totalSupply(
        request: bank_query_pb.QueryTotalSupplyRequest,
        metadata: grpc.Metadata,
    ...
    supplyOf(
        request: bank_query_pb.QuerySupplyOfRequest,
        callback: (error: grpc.ServiceError | null, response: bank_query_pb.QuerySupplyOfResponse) => void,
    ): grpc.ClientUnaryCall;
    supplyOf(
        request: bank_query_pb.QuerySupplyOfRequest,
        metadata: grpc.Metadata,
    ...
    params(
        ...
        callback: (error: grpc.ServiceError | null, response: bank_query_pb.QueryParamsResponse) => void,
    ): grpc.ClientUnaryCall;
    params(
        request: bank_query_pb.QueryParamsRequest,
        metadata: grpc.Metadata,
    ...
    denomMetadata(
        request: bank_query_pb.QueryDenomMetadataRequest,
        callback: (error: grpc.ServiceError | null, response: bank_query_pb.QueryDenomMetadataResponse) => void,
    ): grpc.ClientUnaryCall;
    denomMetadata(
        request: bank_query_pb.QueryDenomMetadataRequest,
        metadata: grpc.Metadata,
    ...
    denomsMetadata(
        request: bank_query_pb.QueryDenomsMetadataRequest,
        callback: (error: grpc.ServiceError | null, response: bank_query_pb.QueryDenomsMetadataResponse) => void,
    ): grpc.ClientUnaryCall;
    denomsMetadata(
        request: bank_query_pb.QueryDenomsMetadataRequest,
        metadata: grpc.Metadata,
